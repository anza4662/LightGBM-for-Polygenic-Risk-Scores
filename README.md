...
# Runtime 
Runtime depends on how many SNPs you are using and how many observations you have. If you have the time please feel free to make a version parralellizing the grid search. :)
